...
let s:gray        = { "gui": "#eeeeee", "cterm": "255" }
let s:dark_gray   = { "gui": "#d0d0d0", "cterm": "252" }

let s:fg          = s:black
let s:bg          = s:gray

let s:comment_fg  = { "gui": "#a0a1a7", "cterm": "247" }
let s:gutter_bg   = { "gui": "#eeeeee", "cterm": "255" }
let s:gutter_fg   = { "gui": "#a0a1a7", "cterm": "247" }
...
call s:h("CursorColumn", "", s:white, "")
call s:h("CursorLine", "", s:white, "")
